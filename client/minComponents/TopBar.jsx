...
const TopBar = (props) => {
  ...
  return (
    <div className={styles.asBar}>
      <div className={styles.asreturnHome}>
        <div className={styles.asarrow}>
          <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" aria-label="Back" role="img" focusable="false" className={styles.asbackIcon}><g fill="none"><path d="m20 28-11.29289322-11.2928932c-.39052429-.3905243-.39052429-1.0236893 0-1.4142136l11.29289322-11.2928932"></path></g></svg>
        </div>
        <div className={styles.astext}>Homes • Beartnt</div>
      </div>
